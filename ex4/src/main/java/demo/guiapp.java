...
public class guiapp {
	boolean serverbool = true;
	public int linesezer = 0;
	public int filesezer = 0;
...
public JLabel numfileslbl = new JLabel("number of files: 0");
...
private JTextField pass;
	...
	private void initialize() {
		...
		frame = new JFrame();
		frame.setBounds(100, 100, 573, 500);
		...
		importBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				showfilter = false;
				threadwork = true;
				if (threadinit == false && serverbool == true) {
					new Thread(){
					      public void run(){
					    	  while (true) {
					    	  ...
					    	  if (threadwork) {
					    		  ...
					    		  folder = importTxt.getText();
									...
									//if (serverbool == true)
										gu1 = new guiUnited(folder,f1,f2,f3,f4,f5,f6,true);
									linesezer = gu1.linesnum;
									filesezer = gu1.filenum;
							        ...
							        SwingUtilities.invokeLater(new Runnable(){
							          public void run(){
							        	  ...
							        	  numfileslbl.setText("number of files: " + filesezer);
											System.out.println(gu1.linesnum);
											lblNumberOfInes.setText("number of lines: " + linesezer);
							          }
							        });
					    	  }
					        }
		...
		importBtn.setBounds(139, 136, 87, 23);
		frame.getContentPane().add(importBtn);
		
		importTxt = new JTextField();
		importTxt.setText("c://knew");
		importTxt.setBounds(10, 137, 119, 20);
		...
		numfileslbl.setBounds(10, 160, 105, 14);
		frame.getContentPane().add(numfileslbl);
		
		
		lblNumberOfInes.setBounds(10, 185, 137, 14);
		...
		btnNewButton.setBounds(139, 162, 87, 37);
		...
		csvsave.setBounds(10, 210, 109, 23);
		...
		kmlsave.setBounds(129, 210, 109, 23);
		...
		lblPositionByMac.setBounds(10, 265, 93, 23);
		frame.getContentPane().add(lblPositionByMac);
		
		algo1txt = new JTextField();
		algo1txt.setBounds(92, 268, 106, 20);
		...
		button.setBounds(200, 299, 68, 23);
		...
		button_1.setBounds(288, 382, 55, 65);
		frame.getContentPane().add(button_1);
		
		JLabel lblImportFromThis = new JLabel("import from server:");
		lblImportFromThis.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblImportFromThis.setBounds(10, 39, 137, 23);
		frame.getContentPane().add(lblImportFromThis);
		
		JLabel lblServerIp = new JLabel("server ip");
		lblServerIp.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblServerIp.setBounds(10, 61, 54, 23);
		frame.getContentPane().add(lblServerIp);
		
		JLabel lblUsername = new JLabel("username");
		lblUsername.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblUsername.setBounds(10, 79, 54, 23);
		frame.getContentPane().add(lblUsername);
		
		JLabel lblPasword = new JLabel("pasword");
		lblPasword.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblPasword.setBounds(10, 99, 54, 23);
		frame.getContentPane().add(lblPasword);
		
		ip = new JTextField();
		ip.setText("5.29.193.52");
		ip.setColumns(10);
		ip.setBounds(68, 60, 119, 20);
		frame.getContentPane().add(ip);
		
		user = new JTextField();
		user.setText("oop1");
		user.setColumns(10);
		user.setBounds(68, 80, 119, 20);
		frame.getContentPane().add(user);
		
		pass = new JTextField();
		pass.setText("Lambda1();");
		pass.setColumns(10);
		pass.setBounds(68, 100, 119, 20);
		frame.getContentPane().add(pass);
		
		JButton button_2 = new JButton("import");
		button_2.setFont(new Font("Tahoma", Font.PLAIN, 11));
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new File(importTxt.getText()+"\\filters").mkdir();
				ArrayList<String> database = new ArrayList<String>();
				MySql ms = new MySql();
				try {
					ms.pickSql(database,ip.getText(),user.getText(),pass.getText());
					String folder = "";
		    		  folder = importTxt.getText();
					String f1 = filtertime1.getText();
					String f2 = filtertime2.getText();
					...
					gu1 = new guiUnited(folder,f1,f2,f3,f4,f5,f6,false);
					serverbool = false;
					linesezer =  gu1.linesnum;
					filesezer = gu1.filenum;
					 numfileslbl.setText("number of files: " + 1);
						System.out.println(gu1.linesnum);
						lblNumberOfInes.setText("number of lines: " + linesezer);
						gu1.filenum = 1;
		...
		button_2.setBounds(188, 62, 68, 55);
		frame.getContentPane().add(button_2);
		
		JLabel lblWorkspace = new JLabel("workspace:");
		lblWorkspace.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblWorkspace.setBounds(10, 118, 93, 23);
		frame.getContentPane().add(lblWorkspace);
